...
--
-- Name: conversations conversations_job_application_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.conversations
    ADD CONSTRAINT conversations_job_application_id_key UNIQUE (job_application_id);
...
--
-- Name: contractor_profiles Anyone can view contractor profiles; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Anyone can view contractor profiles" ON public.contractor_profiles FOR SELECT TO authenticated USING (true);
...
CREATE POLICY "Contractors can update their own profile" ON public.contractor_profiles FOR UPDATE TO authenticated USING (((auth.uid() = user_id) AND public.has_role(auth.uid(), 'contractor'::public.app_role))) WITH CHECK (((auth.uid() = user_id) AND public.has_role(auth.uid(), 'contractor'::public.app_role)));
