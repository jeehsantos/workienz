...
export function HeroSection() {
  return <section className="relative pt-32 pb-20 lg:pt-20 lg:pb-20 gradient-hero overflow-hidden">
      ...
      <div className="container-tight relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 font-display text-balance animate-fade-up" style={{
            ...
            <p className="text-lg lg:text-xl text-muted-foreground mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed animate-fade-up" style={{
            ...
            {/* Stats */}
            <div className="flex flex-wrap justify-center lg:justify-start gap-8 mt-12 pt-8 border-t border-border/50 animate-fade-up" style={{
            animationDelay: "400ms"
          }}>
              <div>
                <p className="text-3xl font-bold font-display text-foreground">10+</p>
                <p className="text-sm text-muted-foreground">Active Workers</p>
              </div>
              <div>
                <p className="text-3xl font-bold font-display text-foreground">5+</p>
          ...
          animationDelay: "300ms"
            ...
            <div className="relative bg-card rounded-2xl shadow-medium p-6 border border-border/50">
              ...
              <div className="space-y-4">
                ...
                type: "Part-time",
                rate: "$25/hr"
              }].map((job, i) => <div key={i} className="bg-secondary/50 rounded-xl p-4 hover:bg-secondary transition-colors cursor-pointer">
