...
export function HeroSection() {
  return (
    <section className="relative pt-32 pb-20 lg:pt-20 lg:pb-20 gradient-hero overflow-hidden">
      ...
      <div className="container-tight relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1
              className="text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 font-display text-balance animate-fade-up"
              style={{
            ...
            <p
              className="text-lg lg:text-xl text-muted-foreground mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed animate-fade-up"
              style={{
                animationDelay: "200ms",
              }}
            >
              Connect with top employers and workers across New Zealand. Whether you're hiring or seeking work, start
              your journey today.
            </p>
            ...
            {/* Stats */}
            <div
              className="flex flex-wrap justify-center lg:justify-start gap-8 mt-12 pt-8 border-t border-border/50 animate-fade-up"
              style={{
