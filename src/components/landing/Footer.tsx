...
export function Footer() {
  return <footer className="bg-foreground text-primary-foreground py-16 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container-tight relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <img src={workieLogoWhite} alt="Workie" className="h-[25px] w-[195px] object-contain" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.platform.map(link => <li key={link.label}>
        ...
        <div className="border-t border-primary-foreground/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-primary-foreground/40 text-sm">© 2026 Workie. All rights reserved.</p>
