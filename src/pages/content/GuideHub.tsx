                ...
                filteredArticles.map((article) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-6 border border-border rounded-2xl bg-card hover:border-primary/50 hover:shadow-xl cursor-pointer transition-all group ${
                        isLocked ? "opacity-75" : ""
                      }`}
                    >
            ...
            <div className="space-y-6">
              {contentBlocks.length > 0 ? (
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: fullArticle.content.replace(/\n/g, "<br />") }}
                />
              ) : (
