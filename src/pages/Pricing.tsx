...
const contractorPlanMeta: Record<
  string,
  {
    gst: string;
    cta: string;
...
const comingSoonFeatures = [
  {
    ...
    description:
      "Your 24/7 assistant to help you understand New Zealand work rights and community articles. Ask questions about settling in, or let the agent find up-to-date guidance from official immigration sites just for you.",
  },
  {
    icon: Globe,
    title: "Native Language Chat Bridge",
    description:
      "Communicate with confidence. Send messages or voice notes in your own language, and we'll translate them into English for the contractor. You receive their replies back in your preferred language instantly.",
  },
];
    ...
    questions: [
      {
        ...
        answer:
          "We offer flexible billing options. One-time purchases (Single Post, 14-Day Sprint) are charged immediately. Subscription plans (Monthly, Quarterly) are billed at the start of each billing cycle. All prices are in NZD and GST is added at checkout.",
      },
      {
    ...
    questions: [
      {
        ...
        answer:
          "We offer a 7-day money-back guarantee for all subscription plans. If you're not satisfied within the first 7 days, contact our support team for a full refund. One-time purchases are non-refundable once a job has been posted.",
      },
      {
        question: "How do I request a refund?",
        answer:
          "To request a refund, please contact our support team at hello@workie.co.nz with your account email and reason for the refund. We typically process refunds within 3-5 business days.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "Single Post allows you to create one job listing that stays active for 14 days. The 14-Day Sprint gives you unlimited job posts during a 14-day period - perfect for seasonal hiring or when you need to fill multiple positions quickly.",
      },
      {
        question: "What does 'Database Access' include?",
        answer:
          "Database Access (available on Monthly and Quarterly plans) lets you browse and search through all job seeker profiles on Workie. You can filter by skills, location, availability, and more - then reach out directly to candidates who match your needs.",
      },
      {
        question: "What benefits do Premium job seekers get?",
        answer:
          "Premium job seekers get 3 applications every 3 days (vs 1 for free users), access to our full article library with career tips, a Priority Badge that makes their profile stand out, and enhanced visibility in employer searches.",
      },
    ],
  },
];
...
const FeatureItem = ({ included, label }: { included: boolean; label: string }) => (
  <li className="flex items-start gap-2.5">
    <div
      className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${included ? "bg-primary/15" : "bg-muted"}`}
    >
...
export default function Pricing() {
  ...
  const { hideUpgradeButtons, isLoading: isHideUpgradeLoading } = useUpgradeButtonVisibility();
    ...
    <main className="min-h-screen">
      ...
      <section className="pt-8 pb-12 lg:pt-12 lg:pb-16 gradient-hero">
        <div className="container-tight">
          <div className="text-center mb-10">
            <h1 className="text-4xl lg:text-5xl font-bold mb-4 font-display">Simple, Fair Pricing</h1>
            ...
            <div className="flex flex-col items-center gap-3 mb-10">
              <TabsList className="grid w-full max-w-md grid-cols-2 h-14 p-1 bg-muted/50">
                <TabsTrigger
                  ...
                  className={`flex items-center gap-2 text-base font-semibold data-[state=active]:bg-primary data-[state=active]:text-primary-foreground ${isToggleLocked && isEmployee() ? "opacity-50 cursor-not-allowed" : ""}`}
                >
                  <Briefcase className="w-5 h-5" />I want to Hire
                  {isToggleLocked && isContractor() && <Lock className="w-3.5 h-3.5 ml-1" />}
                </TabsTrigger>
                <TabsTrigger
                  value="work"
                  disabled={isToggleLocked && isContractor()}
                  className={`flex items-center gap-2 text-base font-semibold data-[state=active]:bg-primary data-[state=active]:text-primary-foreground ${isToggleLocked && isContractor() ? "opacity-50 cursor-not-allowed" : ""}`}
                >
                  <Users className="w-5 h-5" />I want to Work
              ...
              <div className="max-w-4xl mx-auto animate-fade-in">
                ...
                <div className="text-center max-w-lg mx-auto mb-8">
                  ...
                  <p className="text-muted-foreground mb-4 leading-relaxed">
                    Workie is free during early access.
                    <br />
                    In the future, we may introduce paid plans or features. If we do, pricing and terms will always be
                    shown clearly before you're charged.
                  </p>
                </div>
                ...
                <div className="flex justify-center mt-8">
                  <div className="bg-card rounded-2xl shadow-lg border border-border/50 p-8 w-full max-w-sm relative overflow-hidden transition-all hover:shadow-xl">
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-muted-foreground text-sm mt-1">Start hiring for free with basic features</p>
                    </div>
              ...
              <div className="max-w-4xl mx-auto animate-fade-in">
                ...
                <div className="flex justify-center mt-8">
                  <div className="bg-card rounded-2xl shadow-lg border border-border/50 p-8 w-full max-w-sm relative overflow-hidden transition-all hover:shadow-xl">
                    ...
                    <div className="mt-4">
                      <h2 className="text-2xl font-bold font-display">Free Tier</h2>
                      <p className="text-muted-foreground text-sm mt-1">Basic job seeker access</p>
                    </div>
          ...
          <div className="container-tight">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl lg:text-3xl font-bold font-display">Frequently Asked Questions</h2>
              </div>
                  ...
                  >
                    {category.questions.map((item, index) => (
                      ...
                      >
                        ...
                        <AccordionContent className="px-5 pb-4 text-muted-foreground">{item.answer}</AccordionContent>
                      </AccordionItem>
                    ))}
                  </Accordion>
                </div>
      ...
      <section className="py-16">
        <div className="container-tight text-center">
          <h2 className="text-2xl lg:text-3xl font-bold font-display mb-4">Ready to get started?</h2>
      ...
      {planChangeModal &&
        ...
        currentSubscription.price !== null && (
          <PlanChangeModal
